...
public interface Player extends Remote {
	...
	public String transferAccount (String username, String password, String oldIPAddress, String newIPAddress) throws RemoteException;

	
	/*
	 * public String getAllData(String data, String ipAddress) throws
	 * RemoteException;
	 */
